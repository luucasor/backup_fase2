	...
	<body>
		<div class="container-fluid login-container">
			<div class="row-fluid">
				...
				<div class="span9">
					<div class="helpLinks">
						<a href="www.quatenusonline.com.br">Site Quatenus</a> | 
						<a href="http://qbm01.quatenus-system.com.br/quatenus10/qbm/default.aspx?Language=pt-BR&HeaderTitle=Business%20Management">QBM</a> | 
						<a href="#">Wiki </a> | 
						<a href="#">GTI</a> 
					</div>
				</div>
							...
							<div class="row-fluid">
								<div class="span6">
									<div class="carousal-container">
										<div><h2> Quatenus Rastreamento Inteligente </h2></div>
										<ul class="bxslider">
											<li>
												<div id="slide01" class="slide">
													<img class="pull-left" src="{vimage_path('quatenus1.jpg')}">
												</div>
											</li>
											<li>
												<div id="slide02" class="slide">
													<img class="pull-left" src="{vimage_path('quatenus2.jpg')}"/>
												</div>
											</li>
											<li>
											...
											<li>
												<div id="slide04" class="slide">
													<img class="pull-left" src="{vimage_path('quatenus4.jpg')}"/>
												</div>
											</li>
											<li>
												<div id="slide05" class="slide">
													<img class="pull-left" src="{vimage_path('quatenus5.jpg')}"/>
												</div>
											</li>
										</ul>
									</div>
								...
								<div class="span6">
									<div class="login-area">
										<div class="login-box" id="loginDiv">
											<div class="">
												<h3 class="login-header">Login CRM Quatenus</h3>
		</div>
			...
			{/if}
												...
												<div class="control-group">
													<label class="control-label" for="username"><b>Usuário</b></label>
													<div class="controls">
			...
			<div class="control-group">
													<label class="control-label" for="password"><b>Senha</b></label>
				<div class="controls">
											...
											<div class="login-subscript">
												<small> Powered by Bruno {$CURRENT_VERSION}</small>
											</div>
				</div>
										...
										<div class="login-box hide" id="forgotPasswordDiv">
											<form class="form-horizontal login-form" style="margin:0;" action="forgotPassword.php" method="POST">
												<div class="">
													<h3 class="login-header">Esqueceu a senha</h3>
			</div>
			<div class="control-group">
													<label class="control-label" for="user_name"><b>Usuário</b></label>
				<div class="controls">
						...
						<div class="span6 pull-left" >
							<div class="footer-content">
								<small>&#169 2004-{date('Y')}&nbsp;
									<a href="https://www.quatenusonline.com.br"> quatenusonline.com.br</a> | 
									<a href="#">Powered By Bruno</a> | 
									<a href="https:/">Privacy Policy</a> </small>
							</div>
						</div>
						<div class="span6 pull-right" >
							<div class="pull-right footer-icons">
								<small>{vtranslate('', $MODULE)}&nbsp;</small>
								<a href="https://pt-br.facebook.com/quatenusonline"><img src="layouts/vlayout/skins/images/facebook.png"></a>
								&nbsp;<a href="https://twitter.com/QuatenusOnline"><img src="layouts/vlayout/skins/images/twitter.png"></a>
								&nbsp;<a href="https://www.linkedin.com/company/quatenus?trk=prof-following-company-logo"><img src="layouts/vlayout/skins/images/linkedin.png"></a>
								&nbsp;<a href="https://www.youtube.com/c/quatenusonline"><img src="layouts/vlayout/skins/images/youtube.png"></a> 
							</div>
						</div>
					</div>   
				</div>    
