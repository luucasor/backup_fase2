<?php /* Smarty version Smarty-3.1.7, created on 2017-01-12 17:11:58
         compiled from "/opt/lampp/htdocs/crm/includes/runtime/../../layouts/vlayout/modules/Settings/Profiles/DetailView.tpl" */ ?>
<?php /*%%SmartyHeaderCode:4020535845877b8de30c7f7-09257131%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ac838bd69b80b1f6935ed8d8a2fd58e227fb7958' => 
    array (
      0 => '/opt/lampp/htdocs/crm/includes/runtime/../../layouts/vlayout/modules/Settings/Profiles/DetailView.tpl',
      1 => 1482942406,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '4020535845877b8de30c7f7-09257131',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5877b8de609fe',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5877b8de609fe')) {function content_5877b8de609fe($_smarty_tpl) {?>
<div class="container-fluid"><br><div class="row-fluid"><div class="span10"><h3><?php echo vtranslate('LBL_PROFILE_VIEW',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
</h3></div><div class="span2"><button class="btn pull-right" type="button" onclick='window.location.href="<?php echo $_smarty_tpl->tpl_vars['RECORD_MODEL']->value->getEditViewUrl();?>
"'><?php echo vtranslate('LBL_EDIT',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
</button></div></div><div class="clearfix"></div><hr><div class="profileDetailView"><div class="row-fluid"><div class="row-fluid"><label class="fieldLabel span2 muted"><span class="redColor">*</span><?php echo vtranslate('LBL_PROFILE_NAME',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
...
</strong></span></div><div class="row-fluid"><label class="fieldLabel span2 muted"><?php echo vtranslate('LBL_DESCRIPTION',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
...
<?php }else{ ?><?php echo $_smarty_tpl->tpl_vars['DISABLE_IMAGE_PATH']->value;?>
<?php }?>" /><?php }?></td><?php } ?><td style="border-left: 1px solid #DDD !important;"><?php if ($_smarty_tpl->tpl_vars['PROFILE_MODULE']->value->getFields()||$_smarty_tpl->tpl_vars['PROFILE_MODULE']->value->isUtilityActionEnabled()){?><div class="row-fluid"><span class="span4">&nbsp;</span><span class="span4"><button type="button" data-handlerfor="fields" data-togglehandler="<?php echo $_smarty_tpl->tpl_vars['TABID']->value;?>
...
<?php }else{ ?><?php echo $_smarty_tpl->tpl_vars['DISABLE_IMAGE_PATH']->value;?>
<?php }?>" />&nbsp;&nbsp;<?php echo vtranslate($_smarty_tpl->tpl_vars['ACTION_MODEL']->value->getName(),$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
</td><?php if ($_smarty_tpl->getVariable('smarty')->value['foreach']['actions']['last']||($_smarty_tpl->getVariable('smarty')->value['foreach']['actions']['index']+1)%3==0){?></div><?php }?><?php } ?></table></div></td></tr><?php } ?></tbody></table></div></div></div><br></div><?php }} ?>