<?php /* Smarty version Smarty-3.1.7, created on 2016-12-18 19:50:12
         compiled from "C:\xampp\htdocs\crm\includes\runtime/../../layouts/vlayout\modules\Settings\Profiles\EditViewContents.tpl" */ ?>
<?php /*%%SmartyHeaderCode:205595856e874ae50e1-80868201%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '2273695c3b5b98566678103e6a7549e79a6ebc1e' => 
    array (
      0 => 'C:\\xampp\\htdocs\\crm\\includes\\runtime/../../layouts/vlayout\\modules\\Settings\\Profiles\\EditViewContents.tpl',
      1 => 1468488064,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '205595856e874ae50e1-80868201',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5856e874d25ec',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5856e874d25ec')) {function content_5856e874d25ec($_smarty_tpl) {?>
...
"></script><?php } ?><div class="row-fluid padding1per"><span class="span2"><h4><?php echo vtranslate('LBL_COPY_PRIVILEGES_FROM',"Settings:Roles");?>
</h4></span><span class="span6"><select class="select2" id="directProfilePriviligesSelect" style="min-width : 200px" data-placeholder="<?php echo vtranslate('LBL_CHOOSE_PROFILES',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
...
</option><?php }?><?php } ?></select></span></div><br><div class="summaryWidgetContainer"><label class="checkbox"><input type="hidden" name="viewall" value="0" /><input type="checkbox" name="viewall" <?php if ($_smarty_tpl->tpl_vars['RECORD_MODEL']->value->hasGlobalReadPermission()){?>checked="true"<?php }?> /><?php echo vtranslate('LBL_VIEW_ALL',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
...
</span></span></label></div><table class="table table-bordered profilesEditView"><thead><tr class="blockHeader"><th width="30%" style="border-left: 1px solid #DDD !important;"><input checked="true" class="alignTop" type="checkbox" id="mainModulesCheckBox" />&nbsp;<?php echo vtranslate('LBL_MODULES',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
...
</td><?php if ($_smarty_tpl->getVariable('smarty')->value['foreach']['actions']['last']||($_smarty_tpl->getVariable('smarty')->value['foreach']['actions']['index']+1)%3==0){?></div><?php }?><?php } ?></table><?php }?></div></td></tr><?php }?><?php } ?></tbody></table>
<?php }} ?>