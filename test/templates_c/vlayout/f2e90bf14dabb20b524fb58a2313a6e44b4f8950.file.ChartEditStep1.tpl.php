<?php /* Smarty version Smarty-3.1.7, created on 2017-01-12 18:32:43
         compiled from "/opt/lampp/htdocs/crm/includes/runtime/../../layouts/vlayout/modules/Reports/ChartEditStep1.tpl" */ ?>
<?php /*%%SmartyHeaderCode:3370222955877cbcbdaee85-97262481%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f2e90bf14dabb20b524fb58a2313a6e44b4f8950' => 
    array (
      0 => '/opt/lampp/htdocs/crm/includes/runtime/../../layouts/vlayout/modules/Reports/ChartEditStep1.tpl',
      1 => 1482942406,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '3370222955877cbcbdaee85-97262481',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5877cbcc0111a',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5877cbcc0111a')) {function content_5877cbcc0111a($_smarty_tpl) {?>
...
<span class="redColor">*</span></span><span class="span7 row-fluid"><select class="span6 chzn-select" id="primary_module" name="primary_module" <?php if ($_smarty_tpl->tpl_vars['RECORD_ID']->value&&$_smarty_tpl->tpl_vars['REPORT_MODEL']->value->getPrimaryModule()&&$_smarty_tpl->tpl_vars['IS_DUPLICATE']->value!=true){?> disabled="disabled"<?php }?>><optgroup><?php  $_smarty_tpl->tpl_vars['RELATED_MODULE'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['RELATED_MODULE']->_loop = false;
...
</option><?php } ?></optgroup></select><?php if ($_smarty_tpl->tpl_vars['RECORD_ID']->value&&$_smarty_tpl->tpl_vars['REPORT_MODEL']->value->getPrimaryModule()&&$_smarty_tpl->tpl_vars['IS_DUPLICATE']->value!=true){?><input type="hidden" name="primary_module" value="<?php echo $_smarty_tpl->tpl_vars['REPORT_MODEL']->value->getPrimaryModule();?>
" /><?php }?></span></div><div class="row-fluid padding1per"><span class="span3"><div><?php echo vtranslate('LBL_SELECT_RELATED_MODULES',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
" <?php if ($_smarty_tpl->tpl_vars['RECORD_ID']->value&&$_smarty_tpl->tpl_vars['REPORT_MODEL']->value->getSecondaryModules()&&$_smarty_tpl->tpl_vars['IS_DUPLICATE']->value!=true){?> disabled="disabled"<?php }?>><?php  $_smarty_tpl->tpl_vars['PRIMARY_RELATED_MODULE_LABEL'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['PRIMARY_RELATED_MODULE_LABEL']->_loop = false;
...
</option><?php } ?></select><?php if ($_smarty_tpl->tpl_vars['RECORD_ID']->value&&$_smarty_tpl->tpl_vars['REPORT_MODEL']->value->getSecondaryModules()&&$_smarty_tpl->tpl_vars['IS_DUPLICATE']->value!=true){?><input type="hidden" name="secondary_modules[]" value="<?php echo $_smarty_tpl->tpl_vars['REPORT_MODEL']->value->getSecondaryModules();?>
" /><?php }?></span></div><div class="row-fluid padding1per"><span class="span3"><?php echo vtranslate('LBL_DESCRIPTION',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
</textarea></span></div></div><div class="pull-right"><button type="submit" class="btn btn-success nextStep"><strong><?php echo vtranslate('LBL_NEXT',$_smarty_tpl->tpl_vars['MODULE']->value);?>
