<?php /* Smarty version Smarty-3.1.7, created on 2016-09-26 12:31:29
         compiled from "C:\xampp\htdocs\crm\includes\runtime/../../layouts/vlayout\modules\Vtiger\MassEditForm.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1000157e9152104f198-94803072%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b205406ebcb1d5a4747bd309bca7981676aadbae' => 
    array (
      0 => 'C:\\xampp\\htdocs\\crm\\includes\\runtime/../../layouts/vlayout\\modules\\Vtiger\\MassEditForm.tpl',
      1 => 1468488064,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1000157e9152104f198-94803072',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_57e9152119f0f',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_57e9152119f0f')) {function content_57e9152119f0f($_smarty_tpl) {?>
...
"></script><?php } ?><div id="massEditContainer" class='modelContainer'><div class="modal-header contentsBackground"><button type="button" class="close " data-dismiss="modal" aria-hidden="true">&times;</button><h3 id="massEditHeader"><?php echo vtranslate('LBL_MASS_EDITING',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
' /><input type="hidden" id="massEditFieldsNameList" data-value='<?php echo Vtiger_Util_Helper::toSafeHTML(ZEND_JSON::encode($_smarty_tpl->tpl_vars['MASS_EDIT_FIELD_DETAILS']->value));?>
' /><div name='massEditContent'><div class="modal-body tabbable"><ul class="nav nav-tabs massEditTabs"><?php  $_smarty_tpl->tpl_vars['BLOCK_FIELDS'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['BLOCK_FIELDS']->_loop = false;
 $_smarty_tpl->tpl_vars['BLOCK_LABEL'] = new Smarty_Variable;
 $_from = $_smarty_tpl->tpl_vars['RECORD_STRUCTURE']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
 $_smarty_tpl->tpl_vars['smarty']->value['foreach']['blockIterator']['iteration']=0;
foreach ($_from as $_smarty_tpl->tpl_vars['BLOCK_FIELDS']->key => $_smarty_tpl->tpl_vars['BLOCK_FIELDS']->value){
$_smarty_tpl->tpl_vars['BLOCK_FIELDS']->_loop = true;
 $_smarty_tpl->tpl_vars['BLOCK_LABEL']->value = $_smarty_tpl->tpl_vars['BLOCK_FIELDS']->key;
 $_smarty_tpl->tpl_vars['smarty']->value['foreach']['blockIterator']['iteration']++;
?><?php if (count($_smarty_tpl->tpl_vars['BLOCK_FIELDS']->value)>0){?><li <?php if ($_smarty_tpl->getVariable('smarty')->value['foreach']['blockIterator']['iteration']==1){?>class="active"<?php }?>><a href="#block_<?php echo $_smarty_tpl->getVariable('smarty')->value['foreach']['blockIterator']['iteration'];?>
" data-toggle="tab"><strong><?php echo vtranslate($_smarty_tpl->tpl_vars['BLOCK_LABEL']->value,$_smarty_tpl->tpl_vars['MODULE']->value);?>
</strong></a></li><?php }?><?php } ?></ul><div class="tab-content massEditContent"><?php  $_smarty_tpl->tpl_vars['BLOCK_FIELDS'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['BLOCK_FIELDS']->_loop = false;
 $_smarty_tpl->tpl_vars['BLOCK_LABEL'] = new Smarty_Variable;
 $_from = $_smarty_tpl->tpl_vars['RECORD_STRUCTURE']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
 $_smarty_tpl->tpl_vars['smarty']->value['foreach']['blockIterator']['iteration']=0;
foreach ($_from as $_smarty_tpl->tpl_vars['BLOCK_FIELDS']->key => $_smarty_tpl->tpl_vars['BLOCK_FIELDS']->value){
$_smarty_tpl->tpl_vars['BLOCK_FIELDS']->_loop = true;
 $_smarty_tpl->tpl_vars['BLOCK_LABEL']->value = $_smarty_tpl->tpl_vars['BLOCK_FIELDS']->key;
 $_smarty_tpl->tpl_vars['smarty']->value['foreach']['blockIterator']['iteration']++;
?><?php if (count($_smarty_tpl->tpl_vars['BLOCK_FIELDS']->value)>0){?><div class="tab-pane <?php if ($_smarty_tpl->getVariable('smarty')->value['foreach']['blockIterator']['iteration']==1){?>active<?php }?>" id="block_<?php echo $_smarty_tpl->getVariable('smarty')->value['foreach']['blockIterator']['iteration'];?>
"><table class="massEditTable table table-bordered"><tr><?php $_smarty_tpl->tpl_vars['COUNTER'] = new Smarty_variable(0, null, 0);?><?php  $_smarty_tpl->tpl_vars['FIELD_MODEL'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['FIELD_MODEL']->_loop = false;
...
</td><?php }?><?php } ?><?php if ((1 & $_smarty_tpl->tpl_vars['COUNTER']->value)){?><td></td><td></td><?php }?></tr></table></div><?php }?><?php } ?></div></div></div><?php echo $_smarty_tpl->getSubTemplate (vtemplate_path('ModalFooter.tpl',$_smarty_tpl->tpl_vars['MODULE']->value), $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
</form></div><?php }} ?>