<?php /* Smarty version Smarty-3.1.7, created on 2017-01-13 16:25:11
         compiled from "/opt/lampp/htdocs/crm/includes/runtime/../../layouts/vlayout/modules/Settings/ModuleDesigner/EditFieldPopup.tpl" */ ?>
<?php /*%%SmartyHeaderCode:15276725925877179ce610d8-49204320%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e5ef4c79ef5b9ca254fd1cec959492eb73d11d74' => 
    array (
      0 => '/opt/lampp/htdocs/crm/includes/runtime/../../layouts/vlayout/modules/Settings/ModuleDesigner/EditFieldPopup.tpl',
      1 => 1484324590,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '15276725925877179ce610d8-49204320',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_5877179d36740',
  'variables' => 
  array (
    'MODULE' => 0,
    'a_field' => 0,
    ...
    'module' => 0,
    'key' => 0,
    'CAN_ADD_RELATED_LIST' => 0,
  ),
  'has_nocache_code' => false,
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5877179d36740')) {function content_5877179d36740($_smarty_tpl) {?><!DOCTYPE html>
<html>
<head>
...
<tr class="add_related_list" <?php if (!$_smarty_tpl->tpl_vars['CAN_ADD_RELATED_LIST']->value){?>style="display: none;"<?php }?>>
	<td><?php echo vtranslate("LBL_CREATE_RELATED_LIST",$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
</td>
	<td><input type="checkbox" name="add_related_list[]" <?php if (!isset($_smarty_tpl->tpl_vars['a_field']->value['addRelatedList'][$_smarty_tpl->tpl_vars['key']->value])||$_smarty_tpl->tpl_vars['a_field']->value['addRelatedList'][$_smarty_tpl->tpl_vars['key']->value]==true){?>checked="checked"<?php }?> /></td>
</tr>
<?php } ?>
<tr>
...
" onkeyup="md_showOrHideHelpInfoTranslation(this, 'LBL_', 'help-info-translation');"/></td>
</tr>
<?php  $_smarty_tpl->tpl_vars['language'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['language']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['a_languages']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['language']->key => $_smarty_tpl->tpl_vars['language']->value){
...
function md_addRelatedModule()
{
	...
	$(".add_related_list:last").after('<tr class="related_module">'+row+'</tr><tr class="custom_related_module" style="display:none">'+row1+'</tr><tr class="add_related_list" <?php if (!$_smarty_tpl->tpl_vars['CAN_ADD_RELATED_LIST']->value){?>style="display: none;"<?php }?>>'+row2+'</tr>');
...
';
	...
	o_data.addRelatedList				= o_data.UITypeNum == 10 ? $("*[name='add_related_list\\[\\]']").map(function(){return $(this).is(":checked");}).get() : undefined;
...
' == window.parent.defaultLanguage && o_data.helpInfoLabel != '' && o_data.helpInfoLabel_<?php echo $_smarty_tpl->tpl_vars['language']->value;?>
  == '')
