<?php /* Smarty version Smarty-3.1.7, created on 2017-01-12 18:33:55
         compiled from "/opt/lampp/htdocs/crm/includes/runtime/../../layouts/vlayout/modules/Reports/ChartEditStep2.tpl" */ ?>
<?php /*%%SmartyHeaderCode:19277132205877cc13c7b8a5-47107249%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '176f27318ee1f2c87897004dd818454977b65adc' => 
    array (
      0 => '/opt/lampp/htdocs/crm/includes/runtime/../../layouts/vlayout/modules/Reports/ChartEditStep2.tpl',
      1 => 1482942406,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '19277132205877cc13c7b8a5-47107249',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5877cc13d9cbd',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5877cc13d9cbd')) {function content_5877cc13d9cbd($_smarty_tpl) {?>
...
" ><input type="hidden" class="step" value="2" ><input type="hidden" name="mode" value="step3" ><input type="hidden" name="advanced_filter" id="advanced_filter" value="" ><?php $_smarty_tpl->tpl_vars['RECORD_STRUCTURE'] = new Smarty_variable(array(), null, 0);?><?php $_smarty_tpl->tpl_vars['PRIMARY_MODULE_LABEL'] = new Smarty_variable(vtranslate($_smarty_tpl->tpl_vars['PRIMARY_MODULE']->value,$_smarty_tpl->tpl_vars['PRIMARY_MODULE']->value), null, 0);?><?php  $_smarty_tpl->tpl_vars['BLOCK_FIELDS'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['BLOCK_FIELDS']->_loop = false;
...
$_smarty_tpl->tpl_vars['RECORD_STRUCTURE']->value[$_smarty_tpl->tpl_vars['key']->value] = $_smarty_tpl->tpl_vars['BLOCK_FIELDS']->value;?><?php } ?><?php } ?><div class="padding1per border1px"><div class="row-fluid"><h4><strong><?php echo vtranslate('LBL_CHOOSE_FILTER_CONDITIONS',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
</span></div></div><br><div class="pull-right block"><button type="button" class="btn btn-danger backStep"><strong><?php echo vtranslate('LBL_BACK',$_smarty_tpl->tpl_vars['MODULE']->value);?>
