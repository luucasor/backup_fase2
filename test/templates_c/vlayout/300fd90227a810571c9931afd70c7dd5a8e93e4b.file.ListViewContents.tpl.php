<?php /* Smarty version Smarty-3.1.7, created on 2016-11-30 01:52:56
         compiled from "C:\xampp\htdocs\crm\includes\runtime/../../layouts/vlayout\modules\RecycleBin\ListViewContents.tpl" */ ?>
<?php /*%%SmartyHeaderCode:20279583e30f899ae36-18472989%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '300fd90227a810571c9931afd70c7dd5a8e93e4b' => 
    array (
      0 => 'C:\\xampp\\htdocs\\crm\\includes\\runtime/../../layouts/vlayout\\modules\\RecycleBin\\ListViewContents.tpl',
      1 => 1473702393,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '20279583e30f899ae36-18472989',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_583e30f8a99bc',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_583e30f8a99bc')) {function content_583e30f8a99bc($_smarty_tpl) {?>
...
"><input type="hidden" id="deletedRecordsTotalCount" value="<?php echo $_smarty_tpl->tpl_vars['DELETED_RECORDS_TOTAL_COUNT']->value;?>
...
"><?php echo vtranslate($_smarty_tpl->tpl_vars['LISTVIEW_HEADER']->value->get('label'),$_smarty_tpl->tpl_vars['SOURCE_MODULE']->value);?>
...
"><div class="pull-right actions"><span class="actionImages"><a class="restoreRecordButton"><i title="<?php echo vtranslate('LBL_RESTORE',$_smarty_tpl->tpl_vars['MODULE']->value);?>
" class="icon-refresh alignMiddle"></i></a>&nbsp;<a class="deleteRecordButton"><i title="<?php echo vtranslate('LBL_DELETE',$_smarty_tpl->tpl_vars['MODULE']->value);?>
" class="icon-trash alignMiddle"></i></a></span></div></td><?php }?></td><?php } ?></tr><?php } ?></table><!--added this div for Temporarily --><?php if ($_smarty_tpl->tpl_vars['LISTVIEW_ENTRIES_COUNT']->value=='0'){?><table class="emptyRecordsDiv"><tbody><tr><td><?php $_smarty_tpl->tpl_vars['SINGLE_MODULE'] = new Smarty_variable("SINGLE_".($_smarty_tpl->tpl_vars['MODULE']->value), null, 0);?><?php echo vtranslate('LBL_NO_RECORDS_FOUND',$_smarty_tpl->tpl_vars['MODULE']->value);?>
 <?php echo vtranslate($_smarty_tpl->tpl_vars['SOURCE_MODULE']->value,$_smarty_tpl->tpl_vars['SOURCE_MODULE']->value);?>
