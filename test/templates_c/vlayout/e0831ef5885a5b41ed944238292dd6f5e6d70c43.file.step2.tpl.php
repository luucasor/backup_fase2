<?php /* Smarty version Smarty-3.1.7, created on 2016-09-13 14:13:30
         compiled from "C:\xampp\htdocs\crm\includes\runtime/../../layouts/vlayout\modules\Reports\step2.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2616757d8098ad140e4-72182008%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e0831ef5885a5b41ed944238292dd6f5e6d70c43' => 
    array (
      0 => 'C:\\xampp\\htdocs\\crm\\includes\\runtime/../../layouts/vlayout\\modules\\Reports\\step2.tpl',
      1 => 1468488064,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2616757d8098ad140e4-72182008',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_57d8098aedac2',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_57d8098aedac2')) {function content_57d8098aedac2($_smarty_tpl) {?>
...
" <?php if (!empty($_smarty_tpl->tpl_vars['SELECTED_FIELDS']->value)&&in_array($_smarty_tpl->tpl_vars['FIELD_KEY']->value,array_map('decode_html',$_smarty_tpl->tpl_vars['SELECTED_FIELDS']->value))){?>selected=""<?php }?>><?php echo vtranslate($_smarty_tpl->tpl_vars['FIELD_LABEL']->value,$_smarty_tpl->tpl_vars['PRIMARY_MODULE_NAME']->value);?>
...
$_smarty_tpl->tpl_vars['FIELD_LABEL']->_loop = true;
 $_smarty_tpl->tpl_vars['FIELD_KEY']->value = $_smarty_tpl->tpl_vars['FIELD_LABEL']->key;
?><option value="<?php echo $_smarty_tpl->tpl_vars['FIELD_KEY']->value;?>
"<?php if (!empty($_smarty_tpl->tpl_vars['SELECTED_FIELDS']->value)&&in_array($_smarty_tpl->tpl_vars['FIELD_KEY']->value,array_map('decode_html',$_smarty_tpl->tpl_vars['SELECTED_FIELDS']->value))){?>selected=""<?php }?>><?php echo vtranslate($_smarty_tpl->tpl_vars['FIELD_LABEL']->value,$_smarty_tpl->tpl_vars['SECONDARY_MODULE_NAME']->value);?>
</option><?php } ?></optgroup><?php } ?><?php } ?></select></div></div><div class="row-fluid block padding1per"><div class="row-fluid padding1per"><span class="span6"><strong><?php echo vtranslate('LBL_GROUP_BY',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</strong></span><span class="span6"><strong><?php echo vtranslate('LBL_SORT_ORDER',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</strong></span></div><?php $_smarty_tpl->tpl_vars['ROW_VAL'] = new Smarty_variable(1, null, 0);?><?php  $_smarty_tpl->tpl_vars['SELECTED_SORT_FIELD_VALUE'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['SELECTED_SORT_FIELD_VALUE']->_loop = false;
