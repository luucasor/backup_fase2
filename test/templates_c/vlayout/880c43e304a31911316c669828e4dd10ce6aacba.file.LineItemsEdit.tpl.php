<?php /* Smarty version Smarty-3.1.7, created on 2016-09-12 20:09:34
         compiled from "C:\xampp\htdocs\crm\includes\runtime/../../layouts/vlayout\modules\Inventory\LineItemsEdit.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2450157d70b7e72f910-64011962%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '880c43e304a31911316c669828e4dd10ce6aacba' => 
    array (
      0 => 'C:\\xampp\\htdocs\\crm\\includes\\runtime/../../layouts/vlayout\\modules\\Inventory\\LineItemsEdit.tpl',
      1 => 1468488064,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2450157d70b7e72f910-64011962',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_57d70b7e94d02',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_57d70b7e94d02')) {function content_57d70b7e94d02($_smarty_tpl) {?>
...
" /><table class="table table-bordered blockContainer lineItemTable" id="lineItemTab"><tr><th colspan="2"><span class="inventoryLineItemHeader"><?php echo vtranslate('LBL_ITEM_DETAILS',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</span></th><th colspan="2" class="chznDropDown"><div class="row-fluid"><span class="inventoryLineItemHeader"><?php echo vtranslate('LBL_CURRENCY',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
" /></div></th><th colspan="2" class="chznDropDown"><div class="row-fluid"><div class="inventoryLineItemHeader"><span class="alignTop"><?php echo vtranslate('LBL_TAX_MODE',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
</OPTION></select></div></th></tr><tr><td><b><?php echo vtranslate('LBL_TOOLS',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
<?php }else{ ?>0<?php }?></div></td></tr><tr><td width="83%"><span class="pull-right">(-)&nbsp;<b><a href="javascript:void(0)"  id="finalDiscount"><?php echo vtranslate('LBL_DISCOUNT',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
<?php }else{ ?>0<?php }?>" /></span></td></tr><tr><td width="83%"><span class="pull-right"><b><?php echo vtranslate('LBL_PRE_TAX_TOTAL',$_smarty_tpl->tpl_vars['MODULE_NAME']->value);?>
...
<?php }else{ ?>0<?php }?>"/></td></tr><!-- Group Tax - starts --><tr id="group_tax_row" valign="top" class="<?php if ($_smarty_tpl->tpl_vars['IS_INDIVIDUAL_TAX_TYPE']->value){?>hide<?php }?>"><td width="83%"><span class="pull-right">(+)&nbsp;<b><a href="javascript:void(0)" id="finalTax"><?php echo vtranslate('LBL_TAX',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
<?php }else{ ?>0<?php }?></span></td></tr><!-- Group Tax - ends --><tr><td width="83%"><span class="pull-right">(+)&nbsp;<b><a href="javascript:void(0)" id="shippingHandlingTax"><?php echo vtranslate('LBL_TAX_FOR_SHIPPING_AND_HANDLING',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
: <span id="shAmountForTax" ><?php if ($_smarty_tpl->tpl_vars['FINAL']->value['shipping_handling_charge']){?><?php echo $_smarty_tpl->tpl_vars['FINAL']->value['shipping_handling_charge'];?>
<?php }else{ ?>0<?php }?></span></th><th align="right"><button type="button" class="close closeDiv">x</button></th></tr></thead><tbody><?php  $_smarty_tpl->tpl_vars['tax_detail'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['tax_detail']->_loop = false;
 $_smarty_tpl->tpl_vars['loop_count'] = new Smarty_Variable;
...
<?php }else{ ?>0<?php }?></span></td></tr><tr valign="top"><td width="83%" ><div class="pull-right"><b><?php echo vtranslate('LBL_ADJUSTMENT',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
<?php }else{ ?>0<?php }?>"></span></td></tr><tr valign="top"><td  width="83%"><span class="pull-right"><b><?php echo vtranslate('LBL_GRAND_TOTAL',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
<?php }else{ ?>0<?php }?>"></span><?php }?></td></tr><tr valign="top"><td width="83%" ><div class="pull-right"><b><?php echo vtranslate('LBL_BALANCE',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
<?php }else{ ?>0<?php }?>" readonly></span></td></tr><?php }?></table><br><input type="hidden" name="totalProductCount" id="totalProductCount" value="<?php echo $_smarty_tpl->tpl_vars['row_no']->value;?>
